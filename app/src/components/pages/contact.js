...
const ContactUs = () => {
  return (
    <main id="contactPage">
      <p className="text-white text-7xl font-bold text-center font-faster mt-28">
        Contact F1
      </p>
      <div className="grid grid-cols-2 grid-rows-1 text-black m-12 w-5/6 border-black border-2 py-12 bg-slate-100 rounded-2xl text-center mx-auto my-32">
        <div className="m-20">
